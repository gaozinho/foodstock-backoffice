...
class FederatedSale extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['restaurant_id', 'broker_id', 'brokerId', 'subtotal', 'amount', 'deliveryFee', 'orderAmount', 'shortOrderNumber', 'createdDate', 'ordersCountOnMerchant', 'customerName', 'deliveryFormattedAddress'];
