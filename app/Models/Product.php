...
class Product extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['foodstock_name', 'broker_id', 'json_string', 'user_id', 'restaurant_id', 'name', 'description', 'minimun_stock', 'current_stock', 'monitor_stock', 'external_code', 'unit', 'ean', 'unit_price', 'index', 'created_at', 'updated_at', 'image', 'serving', 'enabled', 'deleted', 'initial_step', 'parents'];
