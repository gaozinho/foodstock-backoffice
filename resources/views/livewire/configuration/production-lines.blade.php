<div>
    <form id="form_production_line">
        <input id="jsonProductionLines" class="jsonProductionLines" wire:model="jsonProductionLines" type="hidden" name="jsonProductionLines" value="{{$jsonProductionLines}}" />
            ...
            <div class="card-body">
                <div class="row">
                        <div class="col-lg-8 col-md-12 margin-tb">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-12 col-md-12 text-right">
                                    <button type="button" class="btn btn-primary btn-sm" id="bt_add_item">
                                        <i class="fa fa-plus"></i> Etapa
                                    </button>

                                    <button wire:click="createDefaultProductionLine" type="button" name="createDefaultProductionLine" value="ok"
                                            class="btn btn-sm btn-secondary"><i wire:loading wire:target="createDefaultProductionLine" class="fas fa-cog fa-spin"></i>
                            ...
                            <div>
                                <ul id="items_list" class="list-group">
                                    ...
                                    <li style="list-style:none;" class="an_item {{intval($productionItem->production_line_id) > 0 ? 'ml-5' : ''}}">
                                        <ul class="list-group list-group-horizontal mb-2">
                                            <li class="col-sm-3 list-group-item list-group-item-secondary">
                                                <input class="step" type="hidden" name="step" value="{{$productionItem->step}}" />
                                                
                                                
                                                <input class="father_step" type="hidden" name="father_step" value="{{is_object($productionItem->productionLine) ? $productionItem->productionLine->step : ''}}" />
                                                <h3>Etapa <span class="step_number">{{$productionItem->step}}</span> <i class="fa {{intval($productionItem->production_line_id) > 0 ? 'fa-outdent' : 'fa-indent'}} indent_item"></i></h3>
                                                <input name="color" style="width:100px;" class="color" value="{{$productionItem->color}}" />                                      
                                            </li>
                                            <li class="col list-group-item">
                                                <div class="row justify-content-between mb-2">
                                                    ...
                                                    <div class="col text-right">
                                                        <button type="button" class="btn btn-sm btn-danger text-right bt_trash_item">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-auto">
                                                                <div class="pretty p-switch p-fill">
                                                                    <input
                                                                        name="clickable"
                                                                        class="clickable"
                                                                        type="checkbox" value="{{$productionItem->step}}"
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="pretty p-switch p-fill">
                                                                    <input
                                                                        name="see_previous" type="checkbox" value="{{$productionItem->step}}"
                                                                        class="see_previous"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-auto">
                                                                <div class="pretty p-switch p-fill">
                                                                    <input 
                                                                        name="next_on_click" type="checkbox" value="{{$productionItem->step}}"
                                                                        class="next_on_click"
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-12 col-md-12 text-right">
                                        <button type="submit" class="btn btn-success pr-4 pl-4 text-dark font-weight-bold text-uppercase" id="bt_salvar">
                        ...
                        <div class="col-lg-4 col-md-12 margin-tb">
                            ...
                            <p>
                                Phasellus nisl massa, commodo nec viverra a, facilisis eu orci. Suspendisse potenti. Vestibulum
                                et ex imperdiet, fermentum ante eu, faucibus risus. Proin leo tortor, venenatis eget quam
                                egestas, consequat faucibus est.
                            </p>
                            <p>
                                Suspendisse mattis gravida efficitur. Aliquam erat volutpat. Vestibulum maximus porttitor nulla,
                                at maximus est auctor eu. Vestibulum viverra vel ligula in tincidunt. Integer tristique tellus
                                quam, ac mollis quam pretium id. Aenean nec eros in ligula iaculis luctus. Nulla finibus, elit
