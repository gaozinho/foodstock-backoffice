...
<div>
    ...
    <form class="form-inline">
        <select name="cancellation_code" class="form-control form-control-sm mr-1 mb-2" wire:model.defer="cancellation_code">
        ...
        <button type="button" wire:click="cancellationRequest({{$orderSummaryId}})" class="btn btn-sm btn-secondary"><i wire:loading wire:target="cancellationRequest" class="fas fa-cog fa-spin"></i> Solicitar cancelamento</button>
    </form>
    @else
